...
/**
 * TextSqlNode对象本身就很纯粹sql文本，但它也需要解析的。因为它需要处理替换掉其中的“${}”占位符
 * TextSqlNode 对象有两个内部类: BindingTokenParser 类和 DynamicCheckerTokenParser 类
...
public class TextSqlNode implements SqlNode {
  ...
  /**
   * 判断当前节点是不是动态的
   * 对于 TextSqlNode对象而言，如果内部含有“${}”占位符，那它就是动态的，否则就不是动态的。
   * @return 节点是否为动态
   */
